/***********************************************************************
		...
		Modified by Vineeth Acharya 11/2014
***********************************************************************/
...
reg[5:0] r_in;
reg[3:0] stato;
// cont changed from [5:0] to [4:0] because max(cont) = 25
// reg[5:0] cont;
reg[4:0] cont;
// cont1 changed from integer to [8:0] to accomodate -255 to 255
//integer cont1;
reg[8:0] cont1;
