...
void Vtop::__vlCoverInsert(uint32_t* countp, bool enable, const char* filenamep, int lineno, int column,     const char* hierp, const char* pagep, const char* commentp) {
    static uint32_t fake_zero_count = 0;
    if (!enable) countp = &fake_zero_count;
    *countp = 0;
    SP_COVER_INSERT(countp,  "filename",filenamep,  "lineno",lineno,  "column",column,"hier",string(name())+hierp,"page",pagep,"comment",commentp);
 }
 ...
 void Vtop::_sequent__TOP__3(Vtop__Syms* __restrict vlSymsp) {
    ...
    __Vdly__v__DOT__or1200_dc_fsm__DOT__saved_addr_r =vlTOPp->v__DOT__or1200_dc_fsm__DOT__saved_addr_r;
    __Vdly__v__DOT__or1200_dc_fsm__DOT__cache_inhibit =vlTOPp->v__DOT__or1200_dc_fsm__DOT__cache_inhibit;
    __Vdly__v__DOT__or1200_dc_fsm__DOT__state = vlTOPp->v__DOT__or1200_dc_fsm__DOT__state;
    __Vdly__v__DOT__or1200_dc_fsm__DOT__hitmiss_eval =vlTOPp->v__DOT__or1200_dc_fsm__DOT__hitmiss_eval;
	...
	if ((4 & (IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__state))) {
		...
		if ((1 & (IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__state))) {
		    ...
		    if (((IData)(vlTOPp->dcqmem_cycstb_i) &(IData)(vlTOPp->dcqmem_ci_i))){
			...
			__Vdly__v__DOT__or1200_dc_fsm__DOT__saved_addr_r =((0x1fff&__Vdly__v__DOT__or1200_dc_fsm__DOT__saved_addr_r)|(0xffffe000&vlTOPp->dcqmem_adr_i));
 		   
	}

		    if (((((IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__hitmiss_eval) &(~(IData)(vlTOPp->dcqmem_cycstb_i)))|(IData)(vlTOPp->dcsb_err_i))|(((IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__cache_inhibit)|(IData)(vlTOPp->dcqmem_ci_i))&(IData)(vlTOPp->dcsb_ack_i)))){
		    ...
		    if (((IData)(vlTOPp->dcsb_ack_i) &(0!=(IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__cnt)))){
			__Vdly__v__DOT__or1200_dc_fsm__DOT__cnt =(7&((IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__cnt)-(IData)(1)));
			__Vdly__v__DOT__or1200_dc_fsm__DOT__saved_addr_r =((0xfffffff3&__Vdly__v__DOT__or1200_dc_fsm__DOT__saved_addr_r)|(0xc&(((IData)(1)+(vlTOPp->v__DOT__or1200_dc_fsm__DOT__saved_addr_r>>2))<<2)));
		...
		if ((1 & (IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__state))) {
			...
			if (((IData)(vlTOPp->v__DOT__tagcomp_miss) &(IData)(vlTOPp->dcsb_ack_i))){
			    __Vdly__v__DOT__or1200_dc_fsm__DOT__saved_addr_r =((0xfffffff3&__Vdly__v__DOT__or1200_dc_fsm__DOT__saved_addr_r)|(0xc&(((IData)(1)+(vlTOPp->v__DOT__or1200_dc_fsm__DOT__saved_addr_r>>2))<<2)));
			    ...
			    if ((1 & ((~ (IData)(vlTOPp->v__DOT__tagcomp_miss)) &(~(IData)(vlTOPp->dcqmem_ci_i))))){
		    ...
		    if ((((IData)(vlTOPp->dc_en) & (IData)(vlTOPp->dcqmem_cycstb_i)) &(IData)(vlTOPp->dcqmem_we_i))){
			++(vlSymsp->__Vcoverage[3]);
			__Vdly__v__DOT__or1200_dc_fsm__DOT__saved_addr_r =vlTOPp->dcqmem_adr_i;
			__Vdly__v__DOT__or1200_dc_fsm__DOT__cache_inhibit = 0;
    ...
    vlTOPp->v__DOT__or1200_dc_fsm__DOT__saved_addr_r =__Vdly__v__DOT__or1200_dc_fsm__DOT__saved_addr_r;
    vlTOPp->v__DOT__or1200_dc_fsm__DOT__cache_inhibit =__Vdly__v__DOT__or1200_dc_fsm__DOT__cache_inhibit;
    vlTOPp->v__DOT__or1200_dc_fsm__DOT__state = __Vdly__v__DOT__or1200_dc_fsm__DOT__state;
    vlTOPp->v__DOT__or1200_dc_fsm__DOT__hitmiss_eval =__Vdly__v__DOT__or1200_dc_fsm__DOT__hitmiss_eval;
 }
 ...
 void Vtop::_settle__TOP__4(Vtop__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->dcsb_we_o = ((IData)(vlTOPp->dc_en) ? (IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__store):(IData)(vlTOPp->dcqmem_we_i));
    vlTOPp->dcqmem_err_o = ((IData)(vlTOPp->dc_en) ? (((1==(IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__state))|(3==(IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__state)))&(IData)(vlTOPp->dcsb_err_i)):(IData)(vlTOPp->dcsb_err_i));
    vlTOPp->v__DOT__dcfsm_first_miss_ack = (((1 == (IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__state)) |(3==(IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__state)))&(IData)(vlTOPp->dcsb_ack_i));
    vlTOPp->dcsb_cab_o = ((IData)(vlTOPp->dc_en) & (((1==(IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__state))&(~(IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__cache_inhibit)))|(2==(IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__state))));
    vlTOPp->v__DOT__dcfsm_biu_read = ((IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__hitmiss_eval) |(IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__load));
 }
 ...
 void Vtop::_combo__TOP__5(Vtop__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->dcqmem_err_o = ((IData)(vlTOPp->dc_en) ? (((1==(IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__state))|(3==(IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__state)))&(IData)(vlTOPp->dcsb_err_i)):(IData)(vlTOPp->dcsb_err_i));
    vlTOPp->v__DOT__dcfsm_first_miss_ack = (((1 == (IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__state)) |(3==(IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__state)))&(IData)(vlTOPp->dcsb_ack_i));
    vlTOPp->dcsb_cab_o = ((IData)(vlTOPp->dc_en) & ((((1==(IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__state))&(IData)(vlTOPp->v__DOT__tagcomp_miss))&(~(IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__cache_inhibit)))|(2==(IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__state))));
    vlTOPp->dcqmem_tag_o = ((IData)(vlTOPp->dcqmem_err_o)?0xb:(IData)(vlTOPp->dcqmem_tag_i));
    vlTOPp->dcqmem_dat_o = ((1 & ((IData)(vlTOPp->v__DOT__dcfsm_first_miss_ack) |(~(IData)(vlTOPp->dc_en))))?vlTOPp->dcsb_dat_i:0);
    vlTOPp->dcqmem_ack_o = ((IData)(vlTOPp->dc_en) ? ((((((1==(IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__state))&(~(IData)(vlTOPp->v__DOT__tagcomp_miss)))&(~(IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__cache_inhibit)))&(~(IData)(vlTOPp->dcqmem_ci_i)))|(((((3==(IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__state))&(~(IData)(vlTOPp->v__DOT__tagcomp_miss)))&(IData)(vlTOPp->dcsb_ack_i))&(~(IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__cache_inhibit)))&(~(IData)(vlTOPp->dcqmem_ci_i))))|(IData)(vlTOPp->v__DOT__dcfsm_first_miss_ack)):(IData)(vlTOPp->dcsb_ack_i));
 }
 ...
 void Vtop::_sequent__TOP__6(Vtop__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->v__DOT__dcfsm_biu_read = (((IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__hitmiss_eval) &(IData)(vlTOPp->v__DOT__tagcomp_miss))|((~(IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__hitmiss_eval))&(IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__load)));
 }
 ...
 void Vtop::_settle__TOP__7(Vtop__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->dcqmem_tag_o = ((IData)(vlTOPp->dcqmem_err_o)?0xb:(IData)(vlTOPp->dcqmem_tag_i));
    vlTOPp->dcqmem_dat_o = ((1 & ((IData)(vlTOPp->v__DOT__dcfsm_first_miss_ack) |(~(IData)(vlTOPp->dc_en))))?vlTOPp->dcsb_dat_i:0);
    vlTOPp->dcqmem_ack_o = ((IData)(vlTOPp->dc_en) ? (IData)(vlTOPp->v__DOT__dcfsm_first_miss_ack):(IData)(vlTOPp->dcsb_ack_i));
    vlTOPp->dcsb_cyc_o = ((IData)(vlTOPp->dc_en) ? ((IData)(vlTOPp->v__DOT__dcfsm_biu_read)|(IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__store)):(IData)(vlTOPp->dcqmem_cycstb_i));
    vlTOPp->dcsb_stb_o = ((IData)(vlTOPp->dc_en) ? ((IData)(vlTOPp->v__DOT__dcfsm_biu_read)|(IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__store)):(IData)(vlTOPp->dcqmem_cycstb_i));
    vlTOPp->dcsb_sel_o = (((((IData)(vlTOPp->dc_en) &(IData)(vlTOPp->v__DOT__dcfsm_biu_read))&(~(IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__store)))&(~(IData)(vlTOPp->dcqmem_ci_i)))?0xf:(IData)(vlTOPp->dcqmem_sel_i));
    vlTOPp->v__DOT__dc_addr = ((((IData)(vlTOPp->v__DOT__dcfsm_biu_read) |(IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__store))&(~(IData)(vlTOPp->v__DOT__or1200_dc_fsm__DOT__hitmiss_eval)))?vlTOPp->v__DOT__or1200_dc_fsm__DOT__saved_addr_r:vlTOPp->dcqmem_adr_i);
 ...
 void Vtop::_eval(Vtop__Syms* __restrict vlSymsp) {
    ...
    if ((((IData)(vlTOPp->clk) & (~ (IData)(vlTOPp->__Vclklast__TOP__clk))) |((IData)(vlTOPp->rst)&(~(IData)(vlTOPp->__Vclklast__TOP__rst))))){
