...
void Vtop::__vlCoverInsert(uint32_t* countp, bool enable, const char* filenamep, int lineno, int column,     const char* hierp, const char* pagep, const char* commentp) {
 ...
 void Vtop::_sequent__TOP__1(Vtop__Syms* __restrict vlSymsp) {
	...
	if (vlTOPp->v__DOT__send_en) {
		...
		vlTOPp->v__DOT__tx_conta = 0;
		if (((((((((0 == (IData)(vlTOPp->v__DOT__next_bit)) |(2==(IData)(vlTOPp->v__DOT__next_bit)))|(3==(IData)(vlTOPp->v__DOT__next_bit)))|(4==(IData)(vlTOPp->v__DOT__next_bit)))|(5==(IData)(vlTOPp->v__DOT__next_bit)))|(6==(IData)(vlTOPp->v__DOT__next_bit)))|(7==(IData)(vlTOPp->v__DOT__next_bit)))|(8==(IData)(vlTOPp->v__DOT__next_bit)))){
			...
			if ((2 == (IData)(vlTOPp->v__DOT__next_bit))) {
			    ...
			    vlTOPp->data_out = (1 & ((IData)(vlTOPp->v__DOT__out_reg)>>7));
			}
 else {
			    if ((3 == (IData)(vlTOPp->v__DOT__next_bit))) {
				++(vlSymsp->__Vcoverage[51]);
				vlTOPp->v__DOT__next_bit = 4;
				vlTOPp->data_out = (1&((IData)(vlTOPp->v__DOT__out_reg)>>6));
			    }
 else {
				if ((4 == (IData)(vlTOPp->v__DOT__next_bit))) {
				    ++(vlSymsp->__Vcoverage[52]);
				    vlTOPp->v__DOT__next_bit = 5;
				    vlTOPp->data_out =(1&((IData)(vlTOPp->v__DOT__out_reg)>>5));
				}
 else {
				    if ((5 == (IData)(vlTOPp->v__DOT__next_bit))) {
					++(vlSymsp->__Vcoverage[53]);
					vlTOPp->v__DOT__next_bit = 6;
					vlTOPp->data_out =(1&((IData)(vlTOPp->v__DOT__out_reg)>>4));
				    }
 else {
					if ((6 == (IData)(vlTOPp->v__DOT__next_bit))) {
					    ++(vlSymsp->__Vcoverage[54]);
					    vlTOPp->v__DOT__next_bit = 7;
					    vlTOPp->data_out =(1&((IData)(vlTOPp->v__DOT__out_reg)>>3));
					}
 else {
					    if ((7 ==(IData)(vlTOPp->v__DOT__next_bit))){
						++(vlSymsp->__Vcoverage[55]);
						vlTOPp->v__DOT__next_bit = 8;
						vlTOPp->data_out =(1&((IData)(vlTOPp->v__DOT__out_reg)>>2));
					    }
 else {
						++(vlSymsp->__Vcoverage[56]);
						vlTOPp->v__DOT__next_bit = 9;
						vlTOPp->data_out =(1&((IData)(vlTOPp->v__DOT__out_reg)>>1));
		...
		vlTOPp->v__DOT__tx_conta = (0x3ff & ((IData)(1)+(IData)(vlTOPp->v__DOT__tx_conta)));
	...
	if (vlTOPp->v__DOT__send) {
	    ...
	    if ((1 & ((~ (IData)(vlTOPp->v__DOT__tre)) |(~(IData)(vlTOPp->dsr))))){
	...
	if ((4 & (IData)(vlTOPp->v__DOT__S1))) {
		...
		if ((1 & (IData)(vlTOPp->v__DOT__S1))) {
		    ...
		    vlTOPp->load_dato = 0;
		    vlTOPp->soc = 0;
		    vlTOPp->v__DOT__conta_tmp = (0xf &((IData)(1)+(IData)(vlTOPp->v__DOT__conta_tmp)));
