...
VL_MODULE(Vtop) {
  public:
    ...
    VL_IN8(reset,0,0);
    VL_IN8(start,0,0);
    VL_OUT8(punti_retta,7,0);
    
    // LOCAL SIGNALS
    // Internals; generally not touched by application code
    VL_SIG8(v__DOT__stato,2,0);
    VL_SIG8(v__DOT__cont,7,0);
    VL_SIG8(v__DOT__mar,7,0);
    VL_SIG8(v__DOT__x,7,0);
    VL_SIG8(v__DOT__y,7,0);
    VL_SIG8(v__DOT__t,7,0);
    //char	__VpadToAlign14[2];
    VL_SIG8(v__DOT__mem[16],7,0);
