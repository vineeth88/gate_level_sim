...
// See Vor1200_except.h for the primary calling header

#include "Vor1200_except.h"    // For This
#include "Vor1200_except__Syms.h"
...
VL_CTOR_IMP(Vor1200_except) {
    Vor1200_except__Syms* __restrict vlSymsp = __VlSymsp = new Vor1200_except__Syms(this, name());
    Vor1200_except* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    ...
    esr = VL_RAND_RESET_I(16);
    to_sr = VL_RAND_RESET_I(16);
    sr_we = VL_RAND_RESET_I(1);
    sr = VL_RAND_RESET_I(16);
...
void Vor1200_except::__Vconfigure(Vor1200_except__Syms* vlSymsp, bool first) {
...
Vor1200_except::~Vor1200_except() {
    delete __VlSymsp; __VlSymsp=NULL;
}

// Coverage
void Vor1200_except::__vlCoverInsert(uint32_t* countp, bool enable, const char* filenamep, int lineno, int column,
...
void Vor1200_except::eval() {
    Vor1200_except__Syms* __restrict vlSymsp = this->__VlSymsp; // Setup global symbol table
    Vor1200_except* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Initialize
    if (VL_UNLIKELY(!vlSymsp->__Vm_didInit)) _eval_initial_loop(vlSymsp);
    // Evaluate till stable
    VL_DEBUG_IF(VL_PRINTF("\n----TOP Evaluate Vor1200_except::eval\n"); );
    int __VclockLoop = 0;
    IData __Vchange=1;
...
void Vor1200_except::_eval_initial_loop(Vor1200_except__Syms* __restrict vlSymsp) {
...
void Vor1200_except::_combo__TOP__1(Vor1200_except__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_PRINTF("    Vor1200_except::_combo__TOP__1\n"); );
    Vor1200_except* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
void Vor1200_except::_sequent__TOP__3(Vor1200_except__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_PRINTF("    Vor1200_except::_sequent__TOP__3\n"); );
    Vor1200_except* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Variables
...
void Vor1200_except::_settle__TOP__4(Vor1200_except__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_PRINTF("    Vor1200_except::_settle__TOP__4\n"); );
    Vor1200_except* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->except_start = ((0 != (IData)(vlTOPp->except_type)) 
			    & (IData)(vlTOPp->extend_flush));
...
void Vor1200_except::_combo__TOP__5(Vor1200_except__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_PRINTF("    Vor1200_except::_combo__TOP__5\n"); );
    Vor1200_except* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->v__DOT__tick_pending = ((((((IData)(vlTOPp->sig_tick) 
					& ((IData)(vlTOPp->sr) 
...
void Vor1200_except::_sequent__TOP__6(Vor1200_except__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_PRINTF("    Vor1200_except::_sequent__TOP__6\n"); );
    Vor1200_except* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->except_started = ((IData)(vlTOPp->extend_flush) 
			      & (IData)(vlTOPp->except_start));
...
void Vor1200_except::_settle__TOP__7(Vor1200_except__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_PRINTF("    Vor1200_except::_settle__TOP__7\n"); );
    Vor1200_except* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->except_stop = ((0xfffff000 & (((IData)(vlTOPp->v__DOT__tick_pending) 
					   << 0xc) 
...
void Vor1200_except::_combo__TOP__8(Vor1200_except__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_PRINTF("    Vor1200_except::_combo__TOP__8\n"); );
    Vor1200_except* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->v__DOT__except_flushpipe = ((0 != (IData)(vlTOPp->v__DOT__except_trig)) 
					& (~ (IData)(
...
void Vor1200_except::_settle__TOP__9(Vor1200_except__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_PRINTF("    Vor1200_except::_settle__TOP__9\n"); );
    Vor1200_except* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->flushpipe = (((IData)(vlTOPp->v__DOT__except_flushpipe) 
			  | (IData)(vlTOPp->pc_we)) 
...
void Vor1200_except::_eval(Vor1200_except__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_PRINTF("    Vor1200_except::_eval\n"); );
    Vor1200_except* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
void Vor1200_except::_eval_initial(Vor1200_except__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_PRINTF("    Vor1200_except::_eval_initial\n"); );
    Vor1200_except* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
}

void Vor1200_except::final() {
    VL_DEBUG_IF(VL_PRINTF("    Vor1200_except::final\n"); );
    // Variables
    Vor1200_except__Syms* __restrict vlSymsp = this->__VlSymsp;
    Vor1200_except* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
}

void Vor1200_except::_eval_settle(Vor1200_except__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_PRINTF("    Vor1200_except::_eval_settle\n"); );
    Vor1200_except* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->_combo__TOP__1(vlSymsp);
...
IData Vor1200_except::_change_request(Vor1200_except__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_PRINTF("    Vor1200_except::_change_request\n"); );
    Vor1200_except* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // Change detection
