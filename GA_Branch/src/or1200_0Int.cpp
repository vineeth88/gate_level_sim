	...
	state_index(index_)
{
	stringstream ss;
	ss
    	<< (bitset<32>)	copy_obj->v__DOT__ic_addr 
    	<< (bitset<1>)	copy_obj->v__DOT__icfsm_biu_read
    	<< (bitset<1>)	copy_obj->v__DOT__tagcomp_miss
    	<< (bitset<1>)	copy_obj->v__DOT__icfsm_first_miss_ack
    	<< (bitset<32>)	copy_obj->v__DOT__or1200_ic_fsm__DOT__saved_addr_r
    	<< (bitset<2>)	copy_obj->v__DOT__or1200_ic_fsm__DOT__state 
    	<< (bitset<3>)	copy_obj->v__DOT__or1200_ic_fsm__DOT__cnt
    	<< (bitset<1>)	copy_obj->v__DOT__or1200_ic_fsm__DOT__hitmiss_eval
    	<< (bitset<1>)	copy_obj->v__DOT__or1200_ic_fsm__DOT__load 
...
void state_t::setCktState(Vtop* top) {
	...
	for(int i = 0; i < CONST_NUM_STATE_BITS; ++i) {
		...
		switch(i+1) {
			case 32 :	top->v__DOT__ic_addr = val;
						val = 0;
						break;

			case 33 :	top->v__DOT__icfsm_biu_read = val;
						val = 0;
						break;
			...
			case 35 :	top->v__DOT__icfsm_first_miss_ack = val;
						val = 0;
						break;

			case 67 :	top->v__DOT__or1200_ic_fsm__DOT__saved_addr_r = val;
						val = 0;
						break;

			case 69 :	top->v__DOT__or1200_ic_fsm__DOT__state = val;
						val = 0;
						break;

			case 72 :	top->v__DOT__or1200_ic_fsm__DOT__cnt = val;
						val = 0;
						break;

			case 73 :	top->v__DOT__or1200_ic_fsm__DOT__hitmiss_eval = val;
						val = 0;
						break;

			case 74 :	top->v__DOT__or1200_ic_fsm__DOT__load = val;
						val = 0;
						break;

			case 75 :	top->v__DOT__or1200_ic_fsm__DOT__cache_inhibit = val;
						val = 0;
						break;
...
void setAllXState(Vtop* top) {
	...
	top->v__DOT__ic_addr 				=	rand() & 0xffffffff;
	top->v__DOT__icfsm_biu_read			=	rand() & 0x01; 
	top->v__DOT__tagcomp_miss			=	rand() & 0x01;
	top->v__DOT__icfsm_first_miss_ack	=	rand() & 0x01;
	top->v__DOT__or1200_ic_fsm__DOT__saved_addr_r	=	rand() & 0xffffffff;
	top->v__DOT__or1200_ic_fsm__DOT__state			=	rand() & 0x03;
	top->v__DOT__or1200_ic_fsm__DOT__cnt			=	rand() & 0x07;
	top->v__DOT__or1200_ic_fsm__DOT__hitmiss_eval	=	rand() & 0x01;
	top->v__DOT__or1200_ic_fsm__DOT__load			=	rand() & 0x01;
	top->v__DOT__or1200_ic_fsm__DOT__cache_inhibit	=	rand() & 0x01;

}

void printCktState (Vtop* top) {
	cout
    	<< (uint) ((top->v__DOT__ic_addr >> 24) & 0xff) << "."
    	<< (uint) ((top->v__DOT__ic_addr >> 16) & 0xff) << "."
    	<< (uint) ((top->v__DOT__ic_addr >> 8) & 0xff) 	<< "."
    	<< (uint) (top->v__DOT__ic_addr & 0xff) << " "
    	<< (uint) top->v__DOT__icfsm_biu_read	<< " "
    	<< (uint) top->v__DOT__tagcomp_miss	<< " "
    	<< (uint) top->v__DOT__icfsm_first_miss_ack	<< " "
    	<< (uint) ((top->v__DOT__or1200_ic_fsm__DOT__saved_addr_r >> 24) & 0xff ) << "." 
    	<< (uint) ((top->v__DOT__or1200_ic_fsm__DOT__saved_addr_r >> 16) & 0xff ) << "."
    	<< (uint) ((top->v__DOT__or1200_ic_fsm__DOT__saved_addr_r >> 8)  & 0xff ) << "."
    	<< (uint) ((top->v__DOT__or1200_ic_fsm__DOT__saved_addr_r)	& 0xff) << " "
    	<< (uint) top->v__DOT__or1200_ic_fsm__DOT__state 			<< " "
    	<< (uint) top->v__DOT__or1200_ic_fsm__DOT__cnt				<< " "
    	<< (uint) top->v__DOT__or1200_ic_fsm__DOT__hitmiss_eval	<< " "
    	<< (uint) top->v__DOT__or1200_ic_fsm__DOT__load 			<< " "
    	<< (uint) top->v__DOT__or1200_ic_fsm__DOT__cache_inhibit
		<< endl;	
}
